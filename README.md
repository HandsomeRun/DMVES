...
3. 回放子系统
   ...
   流程:UI 在 Redis 给 playbackTime,回放器周期监听 playbackTime,向 Redis 加载相应的帧信息,加载完成后给 view 发送 update
...
6. 分析子系统
   ...
   - Car 的路径生成时间(折线图 横坐标:导航次数 纵坐标:导航时间)
...
| userPassWord  | varchar(50) |         MD5 加密          |
|   userRole    |    外键     |        用户级别表         |
|  userStatus   |   char(3)   |  待审核，已通过，未通过   |
| registerTime  |  DateTime   |         注册时间          |
|  examineTime  |  DateTime   |     审核时间，可 null     |
| examineUserId |    外键     |    审核人 Id，可 null     |
